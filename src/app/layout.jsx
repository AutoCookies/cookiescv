...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head />
      <body className={`${inter.className} bg-gradient-to-b from-gray-50 to-gray-100 text-gray-900 min-h-screen flex flex-col`}>
        ...
        <header className="bg-gradient-to-r from-indigo-600 to-blue-500 text-white shadow-md sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row justify-between items-center">
            <Link href="/" className="text-2xl font-extrabold tracking-wide hover:text-gray-100 transition duration-200">
              CookiesCV
            </Link>
        ...
        <main className="flex-1 max-w-7xl mx-auto px-4 py-10 w-full">
          <div className="bg-white shadow-lg rounded-xl p-6 sm:p-8">{children}</div>
        </main>

        {/* Footer */}
        <footer className="bg-gray-900 text-gray-300 py-8 text-center text-sm border-t border-gray-700">
